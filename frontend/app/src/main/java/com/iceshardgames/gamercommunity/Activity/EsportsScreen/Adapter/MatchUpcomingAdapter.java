...
public class MatchUpcomingAdapter extends RecyclerView.Adapter<MatchUpcomingAdapter.MatchViewHolder> {

    private List<EsportsMatch> matches;
    private Context context;


    public MatchUpcomingAdapter(Context context, List<EsportsMatch> matches) {
    ...
    public MatchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_match_upcoming, parent, false);
